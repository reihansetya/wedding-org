...
class Panggung(models.Model):
    ...
    _description = 'class panggung'

    name = fields.Char(string='Name', required=True)
    pelaminan_id = fields.Many2one(
        comodel_name='wedding.pelaminan', string='Tipe Pelaminan', required=True)
    ...
    des_pelaminan = fields.Char(
        compute='_compute_des_pelaminan', string='Deskripsi Pelaminan')
    ...
    des_kursipengantin = fields.Char(
        compute='_compute_des_kursipengantin', string='Deskripsi Kursi pengantin')
